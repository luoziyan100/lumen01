...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::files::fetch_open_pdf,
            commands::files::fetch_public_html,
            ...
            commands::research::add_research_artifact,
            commands::research::list_research_artifacts,
            ...
            commands::search::search_paper_citations,
            commands::search::search_paper_references,
        ])
